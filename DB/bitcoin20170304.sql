...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2017 at 05:43 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `explode_table` (`bound` VARCHAR(255))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getInforWebsite` (IN `menu` VARCHAR(100))  BEGIN
	SELECT 
		tbl_about.*
	FROM
		tbl_about
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GET_FEE_AMOUNT_INVEST_LIST` ()  BEGIN
	SELECT 
    feeamount.*
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GET_FEE_AMOUNT_LIST` ()  BEGIN
SELECT 
    *
    FROM feeamount;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `GET_LAST_TRAN_TMP` ()  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GET_POLICY_HOME_LST1` ()  BEGIN
	SELECT
		feeamount.ID
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GET_PROFIT_PLAN` ()  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_ACTIVE_CUSTOMER_ACT1` (IN `customerID` INT, `active` INT)  BEGIN
	UPDATE customer
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_CHANGE_PASSWORD_CUS` (IN `userName` VARCHAR(100), `password_new` VARCHAR(100))  BEGIN
	UPDATE customer
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_DELETE_CUSTOMER_ACT1` (IN `CustomerID` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_DUPLICATE_CUSTOMER` (IN `userName` VARCHAR(100), `email` VARCHAR(100), `sponsor` VARCHAR(100))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_ADMIN_TICKET_LIST` ()  BEGIN
	SELECT
		ticket.ID
	,	ticket.CustomerID
    ,	ticket.question
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_BUSSINESS_REPORT` (IN `P_CustomerID` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_CUSTOMER_LST1` ()  BEGIN
	SELECT
		customer.ID
	,	customer.FullName
    ,	customer.UserName
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_DASHBOARD_DATA_INFO` ()  BEGIN
	DECLARE total_recived_blance 	DOUBLE DEFAULT 0;
    DECLARE total_send_balance		DOUBLE DEFAULT 0;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_DATA_INFO` (IN `P_customerID` INT)  BEGIN
    ...
    ,	investValid		AS invest_valid; END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_FEE_BY_ID` (IN `P_ID` INT)  BEGIN
	SELECT * FROM feeamount WHERE feeamount.ID = P_ID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_PLAN_FEE` ()  select transaction_typ, amount, recived, duration from feeamount where amount <> 0$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_RAND_ADMIN_WALLET` (IN `P_customerID` INT)  BEGIN
	DECLARE investValidDay		INT	DEFAULT	0;
    DECLARE investValid			INT	DEFAULT	1;
    DECLARE countChild			INT	DEFAULT	0;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_STATUS_USER` (IN `P_customerID` INT)  BEGIN        
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_TICKET_LIST` (IN `P_CustomerID` INT)  BEGIN
	SELECT
		ticket.ID
	,	ticket.CustomerID
    ,	ticket.question
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_TRANS_CONFIRMED` ()  BEGIN
	SELECT
		transaction_gh.ID
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_TRANS_GH` (IN `customerId` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_TRANS_PH` (IN `customerId` INT)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_TRANS_SUCCESS` ()  BEGIN
	SELECT
		transaction_ph.ID
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_TRANS_WAITING` ()  BEGIN
	SELECT
		transaction_gh.ID
    ,	transaction_gh.CustomerID
    ,	transaction_gh.amount
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_GET_WALLET_BY_TRAN_ID` ()  BEGIN
	SELECT transaction_gh.CustomerID
    ,	transaction_gh.ID
    ,	transaction_gh.amount
    ,	transaction_gh.senddate
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_LOGIN_ADMIN_LST1` (IN `userName` VARCHAR(100), `password_in` VARCHAR(100))  BEGIN
	SELECT
		c1.ID
	,	c1.Name
	,	c1.Email
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_LOGIN_CUSTOMER_LST1` (IN `userName` VARCHAR(100), `password_in` VARCHAR(100))  BEGIN
	DECLARE adminWallet VARCHAR(500) DEFAULT '';
    SET adminWallet =  (SELECT adminwallet.wallet FROM adminwallet ORDER BY RAND() LIMIT 1);
	SELECT
		c1.ID
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_REGIS_CUSTOMER` (IN `username` VARCHAR(100), `fullname` VARCHAR(100), `password_in` VARCHAR(100), `pin` VARCHAR(255), `mobile` VARCHAR(50), `email` VARCHAR(100), `bitaddress` VARCHAR(500), `referer` VARCHAR(100), `client_ip` VARCHAR(100))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_RESETPASS_CUSTOMER` (IN `userName` VARCHAR(100), `password_new` VARCHAR(100))  BEGIN
	UPDATE customer
    SET customer.Password =  password_new	
    WHERE customer.UserName = userName;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_SAVE_POLICY_ACT1` (IN `P_ID` INT, `P_duration` INT, `P_amount` DOUBLE, `P_recived` DOUBLE)  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_SENDMONEY_ALL` (IN `P_ID` VARCHAR(1000), `issuccess` VARCHAR(1000))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_SEND_ADMIN_TICKET` (IN `P_comment` TEXT, `P_customerID` INT)  BEGIN
	INSERT INTO ticket(
		CustomerID
    ,	question
    ,	senddate
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_TICKET_ANSWER_ACT1` (IN `Id` INT, `P_comment` TEXT)  BEGIN
	UPDATE ticket
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_TRANSACTION_ACTIVE_SENDMONEY_ACT1` (IN `id` INT, `isactive` INT)  BEGIN
	UPDATE transaction_gh
    SET active_sendmoney = isactive
    WHERE ID=id;
		
	SELECT 1 AS success;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_TRANSACTION_APPROVED_ACT1` (IN `P_ID` INT)  BEGIN
    ...
    LEFT JOIN feeamount ON
		transaction_gh.transaction_typ= feeamount.transaction_typ
    SET transaction_gh.status = 2 	,	transaction_gh.remaining_day = feeamount.duration 	,	transaction_gh.active_sendmoney = 1      WHERE transaction_gh.ID = P_ID
    AND transaction_gh.del_flg <> 1;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_TRANSACTION_DELETE_GH_ACT1` (IN `P_ID` INT)  BEGIN
	UPDATE  transaction_gh
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_TRANSACTION_DELETE_PH_ACT1` (IN `P_ID` INT)  BEGIN
	UPDATE  transaction_gh
    SET transaction_gh.del_flg = 1
    WHERE transaction_gh.ID = P_ID;
        UPDATE transaction_ph
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPC_UPDATE_TRANSACTION_GH` (IN `userID` INT, `filePath` VARCHAR(200), `transaction_typ` INT)  BEGIN
	DECLARE amount DOUBLE DEFAULT 0;
...
INSERT INTO `admin` (`ID`, `Username`, `Password`, `Name`, `IsDelete`, `Mobile`, `Email`, `Address`) VALUES
(1, 'admin', '123456', 'Administrator', NULL, NULL, NULL, NULL);
...
INSERT INTO `adminwallet` (`ID`, `wallet`) VALUES
(1, '1GVmZrGTv2pK9jNYd9M1CwowXfbBd5ih7K'),
(2, '1FiEnViouVC1Kt1bJouZ9jen4imEZhoJMc'),
(3, '16XUuQj7XwjKcNNnZhymbVBcTbjUsmTJyV'),
(4, '17R14uWzLyZWMyUbSTp97Zrn5RqUY6qgsH'),
(5, '1L5pEzWQn2igRatysfa7dBPC1By7acVcSg'),
(6, '1FpYxPkwp32Hs3nL8pH3Ywvqpr2KDQXECK'),
(7, '1Aqm3euFVXYDmPCDvY5yaiNpXrjFrTyoJ4'),
(8, '1Lnk9rYHoPBDjiXxaE4oYn9jiz6BTghKxK'),
(9, '14mHHTj89JWxqTkbzqDex5bV15YUbRVeCj'),
(10, '1M7bE2yskYEddAfVxtWRREqgtemWSn4zij');
...
INSERT INTO `customer` (`ID`, `FullName`, `UserName`, `Email`, `Gender`, `Birthday`, `PeoplesIdentity`, `Password`, `PasswordSalt`, `Mobile`, `CreatedDate`, `CustomerAvatarID`, `CountryID`, `IsActive`, `IsDelete`, `ListCustomerId`, `ParentID`, `CustomerID`, `SecondPassword`, `WalletAddress`, `BitcoinQRUrl`, `PhoneCode`, `level`, `ListCustomerRef`, `levecustomerRef`, `listPV`, `IsPH`, `RankID`, `PercentRank`, `ishappy1`, `ishappy2`, `ishappy3`, `TotalSystemBit`, `TotalF1InMonth`, `TotalF2Inmonth`, `TotMember`, `TopIndex`, `client_ip`) VALUES
(1, 'pham tuan hai', 'haipham92', 'haiphamtuan010192@gmail.com', NULL, NULL, '', '$2a$10$1qAz2wSx3eDc4rFv5tGb5eFWsS2l5MtRbJMHQBYXeOnFWm.tW4lXy', 'haihalove123', '01696391964', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, '1LnBMw6aoqGXF1JPRKM5sGavY187Emr7gW', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '27.67.10.54'),
(2, 'alibaba', 'alibaba', 'pentest313@gmail.com', NULL, NULL, '', '$2a$10$1qAz2wSx3eDc4rFv5tGb5eNAzKmbvMU5dZZ2hhRQDgZB6tefh.fve', '123456a@', '012391234', NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, '1M7bE2yskYEddAfVxtWRREqgtemWSn4zij', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1.55.239.92'),
(3, 'maiyeuem', 'maiyeuem', 'pentest314@gmail.com', NULL, NULL, '', '$2a$10$1qAz2wSx3eDc4rFv5tGb5eNAzKmbvMU5dZZ2hhRQDgZB6tefh.fve', '123456a@', '012312312', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, '1M7bE2yskYEddAfVxtWRREqgtemWSn4zij', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1.55.239.92'),
(4, 'Nguyễn Văn Thành', 'nguyenthanh2017', 'nguyenthanhuet@gmail.com', NULL, NULL, '', '$2a$10$1qAz2wSx3eDc4rFv5tGb5eefTzKCx/LNf./BqxzudS.QZxVA6PX66', '123456', '1687522330', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, '14BNJyo1YBJG36Aa1ga7rrBTYaw1yyN7DX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1.52.124.234'),
(5, 'Thanh Bui Duc', 'xaoxuyenxoi12', 'xaoxuyenxoi12@gmail.com', NULL, NULL, '', '$2a$10$1qAz2wSx3eDc4rFv5tGb5eE71RoXe3A7azNGgkQGfs/amTg8heami', 'Saosang101', '0976498383', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, '1Dqih6LMxDzDvvSxWD7cUvxHhu7rWXDz6R', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '14.184.210.212'),
(6, 'Nguyễn Văn Thành', 'thanh2', 'nguyenthanhuet23@gmail.com', NULL, NULL, '', '$2a$10$1qAz2wSx3eDc4rFv5tGb5eprWkuXd.sGMPxStzeRB/KZ92jOLNvZa', '12345', '1687522330', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 'Số 6, Ngõ 104 Cổ Nhuế, Từ Liêm ( gần đường tàu)', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '127.0.0.1'),
(7, 'test', 'test', 'pentest@gmail.com', NULL, NULL, 'alibaba', '$2a$10$1qAz2wSx3eDc4rFv5tGb5e9/d3RpVZLJj7oRVzR/cHeI.k6qRNUjq', '', '', NULL, NULL, NULL, 1, NULL, NULL, 2, NULL, NULL, 'testtesttesttesttest', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '127.0.0.1');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='bảng phí cho các loại giao dịch : 1 ngày, 3 ngày, 5 ngày';

--
-- Dumping data for table `feeamount`
--

INSERT INTO `feeamount` (`ID`, `transaction_typ`, `amount`, `recived`, `duration`, `name`) VALUES
(1, 1, 0.3, 0.45, 30, 'spin 1 months'),
(2, 2, 0.5, 0.8, 60, 'spin 2 months'),
(3, 3, 0.7, 1.3, 90, 'spin 3 months'),
(4, 4, 0, 0.0065, 30, 'bonus from f2'),
(5, 5, 0, 0.001, 30, 'bonus from f1');
...
INSERT INTO `ticket` (`ID`, `CustomerID`, `question`, `senddate`, `answer`, `status`) VALUES
(1, 6, 'ghg', '2017-02-25 20:26:17', 'fdg', 1);
...
INSERT INTO `transaction_gh` (`ID`, `CustomerID`, `amount`, `senddate`, `status`, `image`, `transaction_typ`, `del_flg`, `bonus_from`, `bonus_from_transgh`, `remaining_day`, `active_sendmoney`) VALUES
(1, 6, 0.7, '2017-02-27 23:04:15', 2, 'D:\\work\\xampp2\\htdocs\\bitcoin20170218\\application/../public/upload/customer/6/170227111102021515.jpg', 3, 0, NULL, NULL, 83, 0),
(2, 6, 0.3, '2017-02-28 23:04:15', 2, 'D:\\work\\xampp2\\htdocs\\bitcoin20170218\\application/../public/upload/customer/6/170227111102021515.jpg', 1, 0, NULL, NULL, 27, 0),
(3, 6, 0.7, '2017-03-02 20:44:24', 1, 'D:\\work\\xampp2\\htdocs\\bitcoin20170218\\application/../public/upload/customer/6/170302080803032424.jpg', 3, 0, NULL, NULL, 0, 0),
(4, 2, 0.7, '2017-03-04 08:11:33', 2, 'C:\\xampp\\htdocs\\bitcoin2\\application/../public/upload/customer/2/170304080803033333.jpg', 3, 0, NULL, NULL, 88, 0),
(5, 2, 0.5, '2017-03-04 08:27:41', 1, 'C:\\xampp\\htdocs\\bitcoin2\\application/../public/upload/customer/2/170304080803034141.jpg', 2, 0, NULL, NULL, 0, 0),
(6, 7, 0.7, '2017-03-04 11:15:24', 2, 'C:\\xampp\\htdocs\\bitcoin2\\application/../public/upload/customer/7/170304111103032424.jpg', 3, 0, NULL, NULL, 90, 0),
(7, 2, 0, '2017-03-04 11:15:35', 2, '', 4, 0, 7, 6, 30, 0);
...
INSERT INTO `transaction_ph` (`ID`, `customerID`, `amount`, `level`, `senddate`, `status`, `issuccess`, `gh_id`, `remaining_day`, `active_sendmoney`, `del_flg`) VALUES
(1, 6, 0.014444444444444446, 0, '2017-02-27 23:17:02', 0, 1, 1, 0, 0, 0),
(2, 6, 0.014444444444444446, 0, '2017-02-27 23:34:31', 0, 1, 1, 0, 0, 0),
(3, 6, 0.014444444444444446, 0, '2017-02-27 23:34:35', 0, 1, 1, 0, 0, 0),
(4, 6, 0.014444444444444446, 0, '2017-02-27 23:34:39', 0, 1, 1, 0, 0, 0),
(5, 6, 0.015000000000000001, 0, '2017-02-27 23:35:57', 0, 1, 2, 0, 0, 0),
(6, 6, 0.014444444444444446, 0, '2017-02-27 23:35:57', 0, 1, 1, 0, 0, 0),
(7, 6, 0.015000000000000001, 0, '2017-03-04 08:12:56', 0, 1, 2, 0, 0, 0),
(8, 6, 0.014444444444444446, 0, '2017-03-04 08:12:56', 0, 1, 1, 0, 0, 0),
(9, 2, 0.014444444444444446, 0, '2017-03-04 08:12:56', 0, 1, 4, 0, 0, 0),
(10, 6, 0.015000000000000001, 0, '2017-03-04 11:12:28', 0, 1, 2, 0, 0, 0),
(11, 6, 0.014444444444444446, 0, '2017-03-04 11:12:28', 0, 1, 1, 0, 0, 0),
(12, 2, 0.014444444444444446, 0, '2017-03-04 11:12:28', 0, 1, 4, 0, 0, 0);
...
INSERT INTO `transaction_temp` (`ID`, `UserName`, `Date`, `Status`, `Amount`, `del_flg`) VALUES
(1, 'kendy2310', '2017-01-16 10:00:00', 3, 0.15, 0),
(2, 'minhthanh2017', '2017-01-11 10:45:00', 2, 0.18, 0),
(3, 'jely_autobit', '2017-01-15 10:34:00', 3, 0.15, 0),
(4, 'nguyenhoanglong_2110', '2017-01-11 17:34:00', 3, 0.7, 0),
(5, 'jacktran', '2017-01-10 17:34:00', 3, 0.7, 0),
(6, 'thaonguyen270728', '2017-01-15 17:09:00', 3, 0.35, 0),
(7, 'nguyenhue68', '2017-01-11 16:05:00', 3, 0.18, 0),
(8, 'tranvu1993', '2017-01-11 21:05:00', 3, 0.18, 0),
(9, 'emily_katy', '2017-01-16 22:05:00', 3, 0.5, 0),
(10, 'thanhtrinhhoa', '2017-01-15 22:05:00', 3, 0.5, 0),
(11, 'hoanghai2310', '2017-01-16 11:00:00', 1, 0.35, 0),
(12, 'baby_waller', '2017-01-16 18:00:00', 1, 0.18, 0),
(13, 'oneprice', '2017-01-17 00:00:00', 2, 0.18, 0),
(14, 'alexnguyen2017', '2017-01-17 01:00:00', 1, 0.5, 0);
...
--
-- Indexes for table `feeamount`
--
ALTER TABLE `feeamount`
  ADD PRIMARY KEY (`ID`);
...
--
-- Indexes for table `transaction_gh`
--
ALTER TABLE `transaction_gh`
  ADD PRIMARY KEY (`ID`);

--
-- Indexes for table `transaction_ph`
--
ALTER TABLE `transaction_ph`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `feeamount`
--
ALTER TABLE `feeamount`
...
ALTER TABLE `ticket`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `transaction_gh`
--
ALTER TABLE `transaction_gh`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `transaction_ph`
--
ALTER TABLE `transaction_ph`
