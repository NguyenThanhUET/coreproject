...
INSERT INTO `feeamount` VALUES (1,1,0.3,0.45,30,'spin 1 months'),(2,2,0.5,0.8,60,'spin 2 months'),(3,3,0.7,1.6,90,'spin 3 months'),(4,4,0,0.006,30,'bonus from f2'),(5,5,0,0.003,30,'bonus from f1');
...
CREATE TABLE `transaction_gh` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='user send admin';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transaction_ph` (
  ...
  `del_flg` int(11) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='admin send user';
/*!40101 SET character_set_client = @saved_cs_client */;
...
BEGIN
    ...
    /* INSERT BONUS TO Root*/
    IF P_Root IS NOT NULL AND P_Root <> 0 THEN
		SET amount = (SELECT feeamount.amount FROM feeamount WHERE feeamount.transaction_typ = 5 LIMIT 1);
		INSERT INTO transaction_gh(
			CustomerID
		,	amount
		,	senddate
...
-- Dump completed on 2017-03-05  0:57:55
