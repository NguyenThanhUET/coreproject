...
CREATE TABLE `feeamount` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='bảng phí cho các loại giao dịch : 1 ngày, 3 ngày, 5 ngày';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `feeamount` VALUES (1,1,0.13,0.15,30,'spin 1 months'),(2,2,0.3,0.35,60,'spin 2 months'),(3,3,0.5,0.6,90,'spin 3 months'),(4,4,0,0.0065,30,'bonus from f2'),(5,5,0,0.001,30,'bonus from f1');
...
CREATE TABLE `transaction_gh` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='user send admin';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `transaction_gh` VALUES (1,6,0.003,'2017-02-02 00:00:00',2,NULL,1,0,NULL,NULL,20,1),(2,5,0.002,'2017-02-02 00:00:00',3,NULL,1,0,NULL,NULL,0,1),(3,3,0.002,'2017-02-02 00:00:00',2,NULL,1,0,NULL,NULL,22,0);
...
CREATE TABLE `transaction_ph` (
  ...
  `del_flg` int(11) DEFAULT '0',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='admin send user';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `transaction_ph` VALUES (9,6,0.005,0,'2017-02-21 21:23:36',0,1,1,0,0,0),(10,5,0.005,0,'2017-02-21 21:23:36',0,1,2,0,0,0),(11,3,0.005,0,'2017-02-21 21:23:36',0,1,3,0,0,0),(12,6,0.005,0,'2017-02-21 21:26:16',0,1,1,0,0,0),(13,5,0.005,0,'2017-02-21 21:26:16',0,1,2,0,0,0),(14,3,0.005,0,'2017-02-21 21:26:16',0,1,3,0,0,0),(15,6,0.005,0,'2017-02-21 21:27:00',0,1,1,0,0,0),(16,3,0.005,0,'2017-02-21 21:27:00',0,1,3,0,0,0),(18,6,0.005,0,'2017-02-21 22:04:44',0,1,1,0,0,0),(19,3,0.005,0,'2017-02-21 22:04:44',0,1,3,0,0,0),(21,6,0.005,0,'2017-02-21 22:05:38',0,1,1,0,0,0),(22,3,0.005,0,'2017-02-21 22:05:38',0,1,3,0,0,0),(24,6,0.005,0,'2017-02-21 22:07:31',0,1,1,0,0,0),(25,3,0.005,0,'2017-02-21 22:07:31',0,1,3,0,0,0),(27,6,0.005,0,'2017-02-21 22:07:54',0,1,1,0,0,0),(28,3,0.005,0,'2017-02-21 22:07:54',0,1,3,0,0,0),(30,6,0.005,0,'2017-02-21 22:11:03',0,1,1,0,0,0),(31,3,0.005,0,'2017-02-21 22:11:03',0,1,3,0,0,0),(33,6,0.005,0,'2017-02-21 22:18:25',0,1,1,0,0,0),(34,6,0.005,0,'2017-02-21 22:18:55',0,1,1,0,0,0);
...
-- Dump completed on 2017-02-21 22:42:57
