CREATE DATABASE  IF NOT EXISTS `bitcoin` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `bitcoin`;
...
INSERT INTO `admin` VALUES (1,'administrator','M0n3yCh0cie.c0m','Administrator',NULL,NULL,NULL,NULL);
...
INSERT INTO `feeamount` VALUES (1,1,0.13,0.15,3,'spin 1 day'),(2,2,0.3,0.35,5,'spin 2 day'),(3,3,0.5,0.6,7,'spin 3 day'),(4,4,0,0.0065,3,'bonus from f1'),(5,5,0,0.001,3,'bonus from f2');
...
--
-- Dumping events for database 'bitcoin'
--
...
-- Dump completed on 2017-02-23 22:34:52
